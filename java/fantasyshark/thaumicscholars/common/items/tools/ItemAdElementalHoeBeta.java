...
public class ItemAdElementalHoeBeta extends ItemHoe implements IThaumcraftItems {
    public ItemAdElementalHoeBeta(ToolMaterial enumtoolmaterial) {
        super(enumtoolmaterial);
        this.setCreativeTab(ItemsTS.TABTS);
        this.setRegistryName("ad_elemental_hoe_beta");
        this.setUnlocalizedName(ThaumicScholars.MODID + ".adElementalHoeBeta");
